...
-- should have no image
(6, 1, 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array', 'MDN: Arrays', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 2, null),
...
-- should have no image
(1, 1, 'https://dev.to/devsmitra/28-javascript-array-hacks-a-cheat-sheet-for-developer-5769', 'Array Hacks Cheat Sheet', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null),
...
-- should have no image
(6, 2, 'https://cssgridgarden.com/', 'CSS Grid Garden', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, null),
...
-- should have no image
(1, 2, 'https://developer.mozilla.org/en-US/docs/Web/CSS/animation', 'MDN: CSS Animations', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null),
...
-- should have no image
(6, 3, 'https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps', 'MDN: Progressive Web Apps', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, null),
...
-- should have no image
(1, 3, 'https://www.codinn.dev/', 'React Portfolio Projects', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null),
...
-- should have no image
(6, 4, 'https://www.postgresqltutorial.com/postgresql-tutorial/postgresql-data-types/', 'PostgreSQL Data types', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, null),
...
-- should have no image
(1, 4, 'https://www.khanacademy.org/computing/computer-programming/sql/more-advanced-sql-queries/pc/challenge-karaoke-song-selector', 'Karaoke Song Selector Tutorial', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null);
...
(2, 4, 'https://www.guru99.com/node-js-express.html', 'Node.js Express', 'Online coding bootcamp offering immersive, mentor-led programs in web development, data science, and more.', 4, '../../assets/resource-thumbs/javascript.jpg'),
-- should have no image
(6, 4, 'https://en.wikipedia.org/wiki/Express.js#History', 'History of Express.js', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, null),
(3, 4, 'https://expressjs.com/', 'Express.js Docs', 'Community-driven platform for coding enthusiasts, featuring tutorials, forums, and collaborative coding projects.', 4, '../../assets/resource-thumbs/working-hard.jpg'),
(8, 4, 'https://en.wikipedia.org/wiki/Create,_read,_update_and_delete', 'Wikipedia: CRUD', 'Video-based coding tutorials covering a wide range of topics, from beginner to advanced levels.', 4, '../../assets/resource-thumbs/100-days.jpg'),
-- should have no image
(1, 4, 'https://github.com/expressjs/method-override', 'Express.js Method Override', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null);
...
-- should have no image
(6, 6, 'https://try.ruby-lang.org/', 'Try Ruby', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 2, null),
...
-- should have no image
(1, 6, 'https://rubygarage.org/blog/how-to-learn-ruby-on-rails', 'How to Learn Ruby on Rails', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, null),
