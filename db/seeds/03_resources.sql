...
-- should have no image
(6, 1, 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array', 'MDN: Arrays', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 2, '../../assets/no-image.jpg'),
...
-- should have no image
(1, 2, 'https://developer.mozilla.org/en-US/docs/Web/CSS/animation', 'MDN: CSS Animations', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, '../../assets/no-image.jpg'),
...
-- should have no image
(6, 3, 'https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps', 'MDN: Progressive Web Apps', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, '../../assets/no-image.jpg'),
...
-- should have no image
(1, 4, 'https://www.khanacademy.org/computing/computer-programming/sql/more-advanced-sql-queries/pc/challenge-karaoke-song-selector', 'Karaoke Song Selector Tutorial', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, '../../assets/no-image.jpg');
...
-- should have no image
(6, 5, 'https://en.wikipedia.org/wiki/Express.js#History', 'History of Express.js', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 5, '../../assets/no-image.jpg'),
...
-- should have no image
(1, 5, 'https://github.com/expressjs/method-override', 'Express.js Method Override', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, '../../assets/no-image.jpg');

-- Ruby Category
INSERT INTO resources(creator_id, category_id, url, title, description, rating, thumbnail_url)
-- should have no image
VALUES(4, 6, 'https://www.ruby-lang.org/en', 'Ruby Homepage', 'Interactive coding challenges for all levels, with instant feedback and progress tracking.', 3, '../../assets/no-image.jpg'),
...
-- should have no image
(6, 6, 'https://try.ruby-lang.org', 'Try Ruby', 'Platform providing coding courses, projects, and assessments, with a focus on real-world applications and industry relevance.', 2, '../../assets/no-image.jpg'),
...
-- should have no image
(1, 6, 'https://rubygarage.org/blog/how-to-learn-ruby-on-rails', 'How to Learn Ruby on Rails', 'Personalized coding learning paths tailored to individual goals and skill levels, with adaptive quizzes and assessments.', 5, '../../assets/no-image.jpg'),
